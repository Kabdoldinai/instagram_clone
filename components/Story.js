...
export default function Story({img, username, isUser}) {
    return <div className="relative group cursor-pointer">
        <img className="h-14 rounded-full p-[1.5px] border-red-500 border-2  group-hover:scale-110 transition:transition-transform duration-200 ease-out"  src={img} alt={username}/>
